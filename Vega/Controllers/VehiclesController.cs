...
namespace Vega.Controllers
{
    ...
    public class VehiclesController:ControllerBase
    {
        ...
        [HttpGet]
        public async Task<QueryResultsResource<VehicleResources>> GetVehicles(VehicleQueryResource filterResource)
        {
            var filter = mapper.Map<VehicleQueryResource, VehicleQuery>(filterResource);
            var queryResult = await repository.GetAllVehicles(filter);
            return mapper.Map<QueryResults<Vehicle>, QueryResultsResource<VehicleResources>>(queryResult);
        }
    }
}
